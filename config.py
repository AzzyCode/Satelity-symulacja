...
simulation_duration_hours = 2  # 24h analysis
...
SATELLITE_PHOTO_SIZES_MB = {
    ...
    "geoeye_ocean": 3.03,   # GeoEye @ 10m/px resolution (over ocean, 100x smaller file size)
    "modis": 86.60     # Przykładowa wartość dla MODIS w MB
}